...
class Delivery(BaseEntity):
    ...
    delivery_service = models.ForeignKey(Service, on_delete=models.SET_NULL, related_name='delivery_item', blank=True,
                                         null=True)
    address = models.ForeignKey(Location, on_delete=models.SET_NULL, related_name='delivery_address', blank=True,
                                null=True)
